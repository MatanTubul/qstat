...
class Ingot_JQuery_JqGrid
{
	...
	public static $searchOperators = array(
		'eq' => Ingot_JQuery_JqGrid_Adapter_DbSelect::EQUAL,
		'ne' => Ingot_JQuery_JqGrid_Adapter_DbSelect::NOT_EQUAL,
		'lt' => Ingot_JQuery_JqGrid_Adapter_DbSelect::LESS_THAN,
		'le' => Ingot_JQuery_JqGrid_Adapter_DbSelect::LESS_THAN_OR_EQUAL,
		'gt' => Ingot_JQuery_JqGrid_Adapter_DbSelect::GREATER_THAN,
		'ge' => Ingot_JQuery_JqGrid_Adapter_DbSelect::GREATER_THAN_OR_EQUAL,
		'bw' => Ingot_JQuery_JqGrid_Adapter_DbSelect::BEGIN_WITH,
		'bn' => Ingot_JQuery_JqGrid_Adapter_DbSelect::NOT_BEGIN_WITH,
		'in' => Ingot_JQuery_JqGrid_Adapter_DbSelect::IN,
		'ni' => 'NOT_IN',
		'ew' => Ingot_JQuery_JqGrid_Adapter_DbSelect::END_WITH,
		'en' => Ingot_JQuery_JqGrid_Adapter_DbSelect::NOT_END_WITH,
		'cn' => Ingot_JQuery_JqGrid_Adapter_DbSelect::CONTAIN,
		'nc' => Ingot_JQuery_JqGrid_Adapter_DbSelect::NOT_CONTAIN
	);
	...
	*/
	private function _getFilterParams ($request)
	{
		...
		$arrFilters = array(
			...
			'expression' => $this->_expression[ $request->getParam('searchOper', 'eq') ],
			'options' => array(),
		);
