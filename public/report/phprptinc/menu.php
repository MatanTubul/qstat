...
// Menu
define("EWRPT_MENUBAR_CLASSNAME", "yuimenu", TRUE);
define("EWRPT_MENUBAR_ITEM_CLASSNAME", "yuimenuitem", TRUE);
define("EWRPT_MENUBAR_ITEM_LABEL_CLASSNAME", "yuimenuitemlabel", TRUE);
define("EWRPT_MENU_CLASSNAME", "yuimenu", TRUE);
define("EWRPT_MENU_ITEM_CLASSNAME", "yuimenuitem", TRUE); // Vertical
define("EWRPT_MENU_ITEM_LABEL_CLASSNAME", "yuimenuitemlabel", TRUE); // Vertical
?>
<?php
...
$RootMenu->AddMenuItem(38, $ReportLanguage->Phrase("DetailSummaryReportMenuItemPrefix") . $ReportLanguage->MenuPhrase("38", "MenuText") . $ReportLanguage->Phrase("DetailSummaryReportMenuItemSuffix"), "Server_Incriment_per_monthsmry.php", -1, "", "", TRUE, FALSE);
$RootMenu->AddMenuItem(39, $ReportLanguage->Phrase("ChartReportMenuItemPrefix") . $ReportLanguage->MenuPhrase("39", "MenuText") . $ReportLanguage->Phrase("ChartReportMenuItemSuffix"), "Server_Incriment_per_monthsmry.php#cht_Total_Server_Per_Month", 38, "", "", TRUE, FALSE);
$RootMenu->AddMenuItem(40, $ReportLanguage->Phrase("ChartReportMenuItemPrefix") . $ReportLanguage->MenuPhrase("40", "MenuText") . $ReportLanguage->Phrase("ChartReportMenuItemSuffix"), "Server_Incriment_per_monthsmry.php#cht_Incrimet_Per_Month", 38, "", "", TRUE, FALSE);
$RootMenu->Render();
?>
</div>
<!-- End Main Menu -->
