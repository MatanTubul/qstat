...
define("EWRPT_PROJECT_ID", "{36B9CEB4-9370-4E45-8A7E-04FA6F924597}", TRUE); // Project ID // ### v5.0.2
...
define("EWRPT_CONN_USER", 'qstat', TRUE);
define("EWRPT_CONN_PASS", 'qstat@pwd', TRUE);
define("EWRPT_CONN_DB", 'qstat', TRUE);
...
// General
define("EWRPT_ROOT_RELATIVE_PATH", "..\..\..\..\..\Users\sirshurf\Documents\PHP Report Maker\Projects\project1", TRUE); // Relative path of app root
...
define("EWRPT_RANDOM_KEY", '0tWyzP34qlqThj&q', TRUE); // Random key for encryption
...
?>
<?php
define("EWRPT_FUSIONCHARTS_FREE", FALSE, TRUE); // FusionCharts Free
define("EWRPT_FUSIONCHARTS_JSCLASS_FILE", "FusionCharts/JSClass/FusionCharts.js", TRUE); // FusionCharts
define("EWRPT_FUSIONCHARTS_CHART_PATH", "FusionCharts/Charts/", TRUE); // FusionCharts
